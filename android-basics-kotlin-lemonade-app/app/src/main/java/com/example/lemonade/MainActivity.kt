...
class MainActivity : AppCompatActivity() {
    ...
    private final var TAG = "AppCompatActivity"
    ...
    private fun setViewElements() {
        ...
        val drawImage: ImageView = findViewById(R.id.image_lemon_state)
        drawImage.setImageResource(R.drawable.lemon_squeeze)

        when(lemonadeState) {
            SELECT -> {
                drawImage.setImageResource(R.drawable.lemon_tree)
            ...
            DRINK -> {
                drawImage.setImageResource(R.drawable.lemon_drink)
                textAction.setText(R.string.lemon_drink)
            }
            RESTART -> {
                drawImage.setImageResource(R.drawable.lemon_restart)
